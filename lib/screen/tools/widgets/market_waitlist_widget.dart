      ...
      child: FutureBuilder<List<WaitListItemDTO>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            List<WaitListItemDTO> marketWaitListData = snapshot.data ?? []; // Get fetched data
            return DataTable(
              columns: [
